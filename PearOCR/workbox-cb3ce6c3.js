define(["exports"], (function(t) {
	...
	const n = {
		...
		i = t => [n.prefix, t, n.suffix].filter((t => t && t.length > 0))
		.join("-"),
		r = t => {
			(t => {
	...
	class C {
		constructor(t, e) {
			this.u = {}, Object.assign(this, e), this.event = e.event, this.l = t, this.p = new U, this.g = [], this.R = [...t.plugins], this.m = new Map;
		...
		async cachePut(t, e) {
			...
			const {
				...
				const r = Object.assign(Object.assign({}, n), {
					...
					o = await t.keys(e, r);
				for (const e of o)
					if (i === q(e.url, s)) return t.match(e, n)
	...
	class E extends class {
		...
		constructor(t = {}) {
			t.cacheName = o(t.cacheName), super(t), this._ = !1 !== t.fallbackToNetwork, this.plugins.push(E.copyRedirectedCacheableResponsesPlugin)
		}
		async L(t, e) {
		...
		addToCacheList(t) {
			...
			for (const n of t) {
				...
				const {
					cacheKey: t,
					url: i
				} = y(n), r = "string" != typeof n && n.revision ? "reload" : "default";
	...
	t.NavigationRoute = class extends h {
		constructor(t, {
			...
			super((t => this.W(t)), t), this.M = e, this.P = s
		}
		W({
			url: t,
			request: e
	...
	}, t.registerRoute = d, t.setCacheNameDetails = function(t) {
		r(t)
	}
}));